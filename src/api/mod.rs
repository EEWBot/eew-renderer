...
pub async fn draw(_v: crate::Version, query: Query<DrawQuery>) -> impl IntoResponse {
...
pub async fn maps(_v: crate::Version) -> impl IntoResponse {
    Json(crate::map::map_names())
}

pub async fn map(_v: crate::Version, Path(map_id): Path<String>) -> impl IntoResponse {
